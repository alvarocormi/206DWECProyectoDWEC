...
<body>
    ...
    <div class="items">
      <div class="card" style="width: 15rem; height: 160px">
        <div class="card-body">
          ...
          <a href="./ejercicios/primerosPasos/practicas/UT2 - IntroduccionJavaScript/plantilla.html" class="btn" style="margin-top: 35px;">Ejecutar</a>
        </div>
      </div>
      <div class="card" style="width: 15rem; height: 160px">
        <div class="card-body">
  ...
  <footer>
    <div class="enlaces-footer">
      ...
      <a href="https://github.com/alvarocormi/206DWECProyectoDWEC" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#737373" class="bi bi-github" viewBox="0 0 16 16">
